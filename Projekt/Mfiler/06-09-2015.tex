...
\textbf{Fremmødte:} Mette, Martin, Albert og Mathias 

\textbf{Fraværende:} Anne og Ditte
...
\newline 
\begin{enumerate}
\item Accepttest aftales til onsdag d. 9/12
\item Referencer: brug ikke fodnoter, En liste til sidst med referencer er tilstrækkeligt. Martin tilføjer til LaTeX
\item Placer versionshistorikken ved begyndelse af de dokumenter, hvor versionhistorik er påkrævet.
\item Det er tilladt at lave små ændringer i Hardware og Software efter accepttesten.
\end{enumerate}