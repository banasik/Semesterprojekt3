...
\end{equation}
Da det bliver oplyst at $ R1=R2 $, kan funktionen reduceres. Den kan samtidig simplificeres. I sidste ende fås oveføringsfunktionen, se Bilag for nærmere udregninger: 
\begin{equation}
...
På figur \ref{fig:HW} ses et diagram over, hvordan hele kredsløber er bygget op. Her ses kredsløbet for realiseringen med transduceren og for simuleringen med Analog Discovery.
