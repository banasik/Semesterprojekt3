...
\end{equation} 
Da det er besluttet at den maksimale indput til DAQ'en er 5V, kan forstærkningen (Gain) nu udregnes. 
\begin{equation}
\begin{split}
5V= 11.25mV \cdot G \\
G = 444.44
...
\end{split}
\end{equation}
Da båndbredden ligger over knækfrekvensen for lavpas filtret, er dette godkendt. Hvis båndbredde havde lagt under knækfrekvensen vil operations forstærker ikke kunne arbejde med de ønskede frekvenser. Det er vigtigt at båndbredden er bred nok til at kunne indeholde frekvenser fra begge side af knækfrekvensen.\\
\newline 
